...
class Dept(models.Model):
    ...
    name = models.CharField(max_length=20, db_column='dname', default='', verbose_name='部门名称')
...
class Emp(models.Model):
   ...
   name = models.CharField(max_length=20, db_column='ename', verbose_name='员工姓名', default='')
